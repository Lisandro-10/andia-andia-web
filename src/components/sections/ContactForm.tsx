...
interface ContactFormProps {
  /**
   * 'section' (default): full section with heading, container and padding — used on homepage.
   * 'inline': bare form only, no wrapper or heading — used when embedded inside another layout.
   */
